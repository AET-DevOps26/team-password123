...
import com.teampassword123.nutrition.domain.MealItem;
...
import com.teampassword123.nutrition.repository.PhotoLogRepository;
...
public class MealService {
    ...
    public MealResponse createManual(UUID userId, ManualMealRequest request) {
        MealLog meal = buildMeal(userLookupService.byId(userId), request, SourceType.MANUAL);
    ...
    public MealResponse convertPhotoToManual(UUID userId, UUID photoId, ManualMealRequest request) {
        ...
        MealLog meal = meals.save(buildMeal(userLookupService.byId(userId), request, SourceType.PHOTO_MANUAL));
    ...
    private MealLog buildMeal(AppUser user, ManualMealRequest request, SourceType sourceType) {
