...
class AnalyticsServiceTest {
    ...
    @Mock
    private NutritionGoalRepository goals;
    ...
    private static NutritionGoal goal(double cal, double protein, double carbs, double fat, double fiber) {
    ...
    void dailyDeltaIsActualMinusGoalWithMultiplierOne() {
        ...
        when(goals.findByUserId(USER_ID))
                .thenReturn(Optional.of(goal(2000, 150, 200, 70, 30)));
