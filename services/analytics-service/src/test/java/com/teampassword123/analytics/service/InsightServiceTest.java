...
class InsightServiceTest {
    ...
    void buildsEatingProfileFromWindowMeals() {
        ...
        ArgumentCaptor<GenAiInsightRequest> captor =
                ArgumentCaptor.forClass(GenAiInsightRequest.class);
    ...
    void mapsGenAiResponseOnHappyPath() {
        ...
        GenAiInsightResponse genai =
                new GenAiInsightResponse(
                        ...
                        List.of(
                                new FactRef(
                                        "fiber-legumes-001", "Legumes are high in soluble fiber.")),
                        "logos:gpt-oss-120b",
                        "success");
        ...
        assertThat(response.factsUsed())
                .containsExactly(
                        new FactRef("fiber-legumes-001", "Legumes are high in soluble fiber."));
