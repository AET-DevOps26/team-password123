...
public class SecurityConfig {
    ...
    SecurityFilterChain securityFilterChain(
        ...
        return http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(
                        auth ->
                                auth.requestMatchers(
                                                ...
                                                "/api/auth/login")
                                        .permitAll()
                                        // Reading flags is public (the web app fetches them on
                                        // startup),
                                        // but flipping them (PUT) mutates global app state and must
                                        // be
                                        // authenticated — otherwise any anonymous caller can toggle
                                        // it.
                                        .requestMatchers(
                                                HttpMethod.GET, "/api/features", "/api/features/**")
                                        .permitAll()
                                        .requestMatchers(
                                                "/swagger-ui.html",
                                                "/swagger-ui/**",
                ...
                .addFilterBefore(
                        new LoginRateLimitFilter(10, 60_000L),
